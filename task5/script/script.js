...
// В этом задании повторены ошибки из предыдущего. Попробуйте самостоятельно провести работу над ошибками и на основе комментариев в предыдущем задании исправить ошибки здесь :)